                ...
                <div className="mt-4">
                    <div className="flex items-center justify-between p-2 bg-gray-100 rounded">
                        ...
                        <button
                            ...
                            className={`text-red-500 hover:text-red-700 ${isUploading ? 'cursor-not-allowed opacity-50' : ''
                                }`}
                        >
                            <X className="h-5 w-5" />
                        </button>
                    ...
                    <div className="mt-2 flex gap-4">
                        <button
                            ...
                            className={`w-full py-2 px-4 rounded-2xl text-white font-medium ${isUploaded
